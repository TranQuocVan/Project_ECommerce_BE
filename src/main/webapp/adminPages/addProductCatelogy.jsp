            ...
            <div class="row mt-5">
                ...
                <div class="col-9">
                    <form id="addCatalogForm">
                        ...
                        <div class="message" id="message"></div> <!-- Hiển thị kết quả -->
                    </form>
                </div>
            </div>
        </div>
...
<script type="module" src="${pageContext.request.contextPath}/scripts/admin/addProductCategory.js?v=${System.currentTimeMillis()}"></script>
