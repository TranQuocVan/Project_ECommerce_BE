...
CREATE TABLE `shoppingcartitems` (
  ...
  KEY `sizeId` (`sizeId`),
  KEY `userId` (`userId`),
  CONSTRAINT `shoppingcartitems_ibfk_1` FOREIGN KEY (`sizeId`) REFERENCES `sizes` (`sizeId`),
  CONSTRAINT `shoppingcartitems_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`)
...
INSERT INTO `shoppingcartitems` VALUES (277,2,118,5);
...
-- Dump completed on 2025-04-14  8:21:03
